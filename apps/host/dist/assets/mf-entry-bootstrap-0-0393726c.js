...
const __mfRemoteEntryPrefetchUrls = ["http://localhost:5002/remoteEntry.js","http://localhost:5001/remoteEntry.js"];
...
(async () => {
  const __mfHostInit = await __mfImport("./hostInit-C2RLgMkV.js");
  ...
  const __mfRemotePreloads = [__mfPreloadRemote("__mfe_internal__host__mf_owner__1__remote_portfolio", "remote_portfolio"),__mfPreloadRemote("__mfe_internal__host__mf_owner__1__remote_trading", "remote_trading")];
...
})().then(() => __mfImport("./index-B-cG3CS4.js"));
